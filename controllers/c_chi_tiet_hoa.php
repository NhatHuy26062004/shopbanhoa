...
class C_chi_tiet_hoa
{
    public function hien_thi_trang_chi_tiet_hoa()
    {
        ...
        if ($hoa) {
            ...
            // Xử lý trường hợp không tìm thấy hoa
    ...
    private function TheoMaKH($id)
    {
        ...
        if ($hoa_dau && $hoa_dau->ma_hoa != $id) {
            $this->XoaNeuGiongID_MaKH($id, $ds_lich_su, $m_lich_su, $ma_kh);
    ...
    private function XoaNeuGiongID_MaKH($id, $ds_lich_su, $m_lich_su, $ma_kh)
    {
