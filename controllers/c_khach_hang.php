...
class C_khach_hang
{
    ...
    public function GuiMail($ma_hoa_don)
    {
        ...
        $mail->Password = 'otbj nogy pwtq qgpq';                           
        $mail->setFrom('nhathuy26062004dz@gmail.com', 'Shop Huy Quần Hoa');
        ...
        $noidung.="<div style='margin:0 0 5px 0'>".number_format($_SESSION['tong_tt'])."VNĐ </div>";
