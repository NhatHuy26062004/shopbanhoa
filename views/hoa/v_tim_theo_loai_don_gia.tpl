        ...
        <div class="block block-anav">
            ...
            <ul class="nav-accordion left">
                <ul class="level0" style="display: block;">
                    ...
                    <li>
                        <i class="fa-regular fa-hand-point-right fa-lg"></i><span class="maLoai" id="maloai_{$loai_hoa->MaLoai}">{$loai_hoa->TenLoai}</span>
                    </li>
                    {/foreach}
                </ul>
            </ul>
                            ...
                            <dd class="Giá bán toggle-content odd">
                                <ol>
                                     <li class="tim_theo_gia" id="0-500000">
                                        ...
                                        <span class="price">{number_format(500000)}&nbsp;VNĐ</span>
                                     </li>
                                     <li class="tim_theo_gia" id="500000-1000000">
                                        <span class="price">{number_format(500000)}&nbsp;VNĐ- </span> 
                                        <span class="price">{number_format(1000000)}&nbsp;VNĐ</span>
                                     </li>
                                 </ol>
                            </dd>
